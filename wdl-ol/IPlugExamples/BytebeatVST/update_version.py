...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright nimaid, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/BytebeatVST-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BytebeatVST-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BytebeatVST-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BytebeatVST-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BytebeatVST-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BytebeatVST-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/BytebeatVST-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/BytebeatVST.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BytebeatVST.iss",inplace=1):
